...
This vignette shows example usage and guides you through the basic functionalities of 'tidyprompt', demonstrating
how to use and create prompt wraps and send prompts to LLMs.
