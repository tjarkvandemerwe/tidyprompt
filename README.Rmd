...
For key functions, 'tidyprompt' may support native processing; currently,
`answer_as_json()` offers support for the respective native options of the 
Ollama and OpenAI API (including supplying JSON schemas). 
