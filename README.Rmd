...
Suitable for all chat-completing LLMs, including those that do not natively support structured output.

* **feedback and retries**: Implement automatic retries with feedback to the LLM
