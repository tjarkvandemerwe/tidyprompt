...
best for your use case. When combining multiple prompt wraps,
'text-based' handling appears to be generally more flexible and robust. 
...
powerful tool for a wide range of use cases, without focusing too much on
maintaining a large number of provider-specific features.
