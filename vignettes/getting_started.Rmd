...
`modify_fn`, `extraction_fn`, and `validation_fn` may all take the
...
object, which represents the tidyprompt object that they are a part of. This
allows for advanced configuration of the prompt and the extraction and validation logic
based on other prompt wraps.
