...
'tidyprompt' offers various 'answer_as' functions, such as `answer_as_boolean()`, `answer_as_regex()`,
`answer_as_code()`, and `answer_as_json()`. For users of specific LLM providers,
`answer_as_json()` may be most powerful when their provider has native support for
