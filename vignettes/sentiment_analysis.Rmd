...
#> 1                          I love this product!              99
#> 2                      This product is terrible               2
#> 3            The customer service was excellent              95
#> 4      I am very disappointed with this product               4
#> 5           The delivery was fast and efficient              95
#> 6  I would not recommend this product to anyone               3
#> 7              It was not bad, not great either              50
#> 8                                           Meh              50
#> 9            It felt like walking up a mountain              42
#> 10                                I am angry!!!              99
```
...
if (file.exists(here::here("man", "figures", "plot_sentiment_analysis-1.png"))) {
  knitr::include_graphics(here::here("man", "figures", "plot_sentiment_analysis-1.png"))
 } else if (file.exists("./man/figures/plot_sentiment_analysis-1.png")) {
   knitr::include_graphics("./man/figures/plot_sentiment_analysis-1.png")
 } else if (file.exists("../man/figures/plot_sentiment_analysis-1.png")) {
   knitr::include_graphics("../man/figures/plot_sentiment_analysis-1.png")
 }
```
